...
'''
model = Sequential()
model.add(Dense(128, activation='elu', input_dim = dim, activity_regularizer=regularizers.l1(10e-5)))
model.add(Dense(64, activation='elu', activity_regularizer=regularizers.l1(10e-5)))
model.add(Dense(15, activation='elu', activity_regularizer=regularizers.l1(10e-5)))

model.add(Dense(64, activation='elu', activity_regularizer=regularizers.l1(10e-5)))
model.add(Dense(128, activation='elu', activity_regularizer=regularizers.l1(10e-5)))
...
'''
model = Sequential()
model.add(Dense(64, activation='elu', input_dim = dim))
model.add(Dense(32, activation='elu'))

model.add(Dense(64, activation='elu'))
model.add(Dense(dim, activation='elu'))
